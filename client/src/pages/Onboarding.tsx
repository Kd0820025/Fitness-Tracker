...
const Onboarding = () => {
  ...
  localStorage.getItem("fitnessUser") || "{}"
);
      ...
      <div className="onboarding-container">
        ...
        <div className="p-6 pt-12 onboarding-wrapper">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-slate-800 dark:text-white">FitCompanion</h1>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">This helps us calculate your needs</p>
                    </div>  
                </div>
                <Input label="Age" type="number" className="max-w-2xl" value={formData.age} onChange={(v)=>updateField('age', v=== "" ? "" : Number(v))} placeholder="Enter your age" min={13} max={120} required/>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="space-y-6 onboarding-wrapper">
                ...
                <div className="flex flex-col gap-4 max-w-2xl">
                    <Input label="Weight (kg)" type="number"  value={formData.weight} onChange={(v)=>updateField('weight', v === "" ? "" : Number(v))} placeholder="Enter your weight" min={20} max={300} required/>

                    <Input label="height (cm) - Optional" type="number"  value={formData.height} onChange={(v)=>updateField('height', v === "" ? "" : Number(v))} placeholder="Enter your height" min={100} max={250} />
                </div>
              ...
              <div className="space-y-6 onboarding-wrapper">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">we'll tailor your experience</p>
                    </div>  
                </div>
                ...
                <div className="space-y-8 max-w-lg">
                    ...
                    <div className="space-y-6">
                        ...
                        <Slider label="Daily Calorie Burn" min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v)=>updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories you aim to burn through exercises and activity each day."/>  
                    </div>  
                </div>  
              </div>
            )}
